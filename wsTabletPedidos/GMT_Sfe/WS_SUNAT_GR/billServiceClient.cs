...
namespace GMT_Sfe.WS_SUNAT_GR
{
  ...
  public class billServiceClient : ClientBase<billService>, billService
  {
    ...
    public byte[] sendBill(string _param1, byte[] _param2, string _param3)
    {
    ...
    public string sendPack(string _param1, byte[] _param2, string _param3)
    {
    ...
    public string sendSummary(string _param1, byte[] _param2, string _param3)
    {
