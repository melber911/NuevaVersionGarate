<%@ Page Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" Inherits="frmListadoMesasPagar" CodeBehind="frmListadoMesasPagar.aspx.cs" %>
...
.mesa-btn:hover {
    ...
    <script>
        function VerPedidosDivsion() {
            document.getElementById("<%=btnDivision.ClientID %>").click();
        }
                ...
                <div class="container mb-4 pb-3 pt-3 shadow bg-body rounded">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 d-flex justify-content-end">
                            <button type="button" onclick="this.disabled=true;VerPedidosDivsion();" class="btn btn-info mr-1" style="border-radius: 15px;">
                                <i class="fa fa-bar-chart" aria-hidden="true"></i>
                                Pedidos División
                            </button>
                            <asp:Button ID="btnDivision" class="btn btn-secondary btn-lg" runat="server" Text="Ver Pedidos División" OnClick="btnDivision_Click" Style="display: none" />
                            <button  type="button" onclick="this.disabled=true;VerPedidosParaLlevar()" class="btn btn-info" style="border-radius: 15px;">
                                <i class="fa fa-bar-chart" aria-hidden="true"></i>
                                Pedidos Llevar
                            </button>
                            <asp:Button ID="btnParaLLevar" class="btn btn-secondary btn-lg" runat="server" Text="Ver Pedidos Para Llevar" OnClick="btnParaLLevar_Click" Style="display: none" />
                        </div>
                    </div>
                </div>
                <div class="container mb-4 pb-3 pt-3 shadow bg-body rounded">
            ...
            <div class="modal-dialog modal-lg">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <div class="modal-content">
                            <div class="modal-header shadow bg-body">
                                <h4 class="modal-title" id="myLargeModalLabel2">Listado de Pedidos para Llevar</h4>
                                <button type="button" style="padding: 0px;" title="cerrar" class="close " data-dismiss="modal" aria-label="Close">
                                    <span style="border-radius: 0px  0px 0px 5px" class="btn btn-danger btn-lg" aria-hidden="true"><i class="fa fa-times-circle"></i></span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <div class="container mb-4 pb-3 pt-3">
                                    <div class="row">
                                        <div class="col">
                                            <div class="table-responsive shadow-lg bg-body rounded">
                                                <asp:GridView ID="gdListadoPedidos2" runat="server" CssClass="table table-hover table-sm table-bordered mb-0" AutoGenerateColumns="false"
                                                    OnRowCommand="gdListadoPedidos2_RowCommand" OnRowDataBound="gdListadoPedidos2_RowDataBound"
                                                    ShowHeaderWhenEmpty="true" EmptyDataText="No se encontraron pedidos para llevar"
                                                    PagerStyle-CssClass="pager" AllowSorting="true" AllowPaging="true" PageSize="6" OnPageIndexChanging="gdListadoPedidos2_PageIndexChanging">
                                                    <HeaderStyle CssClass="thead-dark" />
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="#"
                                                            ItemStyle-Width="20px"
                                                        ...
                                                        <asp:TemplateField HeaderText=""
                                                            ...
                                                            ItemStyle-CssClass="align-middle">
                                                            <ItemTemplate>
                                                                <asp:LinkButton runat="server" ID="ibtBuscar" ToolTip="Detalle" OnClientClick="detalle2();"
                                                                    CommandArgument='<%# ((GridViewRow) Container).RowIndex + "|" + Eval("ordenID") + "|" + Eval("ordenSalon") + "|" + Eval("ordenMesa") + "|" + Eval("ordenEstado") + "|" + Eval("comprobanteNumDocu")%>'
                                                                    CommandName="Detalle">
                                                                    <i style="color: #17a2b8;" class="fa fa-search"></i>
                                                                </asp:LinkButton>
