<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="frmPedidoMesas.aspx.cs" Inherits="WebSites.frmPedidoMesas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function NoHayMesa(mesa) {
            swal({
                title: "Aviso",
                text: "Ya existe una orden en la mesa " + mesa,
            ...
            toastr.error('Ya existe una orden en la mesa ' + mesa, 'Error');
        };
        function validarCantidad(input) {
            // Convierte el valor a número
            let valor = parseInt(input.value, 10);

            // Si el valor es menor que 1, ajusta el input al mínimo permitido
            if (valor < 1 || valor > 1000 || isNaN(valor)) {
                input.value = 1;
            }
        }
    </script>
                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Ordenar Pedido</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="form-row mb-4">
                        <div class="col-md-12">
                            <asp:UpdatePanel runat="server">
                                <ContentTemplate>
                                    <button type="button" class="btn btn-sm btn-success btn-block mb-2" style="border-radius: 15px;" onclick="this.disabled=true; EnviarCocina();">
                                    ...
                                    <div class="form-row align-items-center">
                                        <div class="col-auto">
                                            <label runat="server" id="lblcantper" class="font-weight-bold">Cantidad Personas:</label>
                                            <label runat="server" id="lblCliente" class="font-weight-bold">Nombre Cliente:</label>
                                        </div>
                                        <div class="col-auto">
                                            <input min="0" class="form-control form-control-sm"  id="txtcantper" style="width:60px" runat="server" type="number" />
                                            <input  class="form-control form-control-sm"  id="txtcliente" placeholder="Nombre - Apellido" maxlength="60" runat="server" type="text" />
                                        </div>
                                    </div>
                                </ContentTemplate>
                            </asp:UpdatePanel>
                    ...
                    <asp:UpdatePanel ID="UP3" UpdateMode="Conditional" runat="server">
                        <ContentTemplate>
                            <div class="form-row mb-1">
                                <div class="col-12 ">
                                    <label class="p-1 font-weight-bold">Total:</label><label runat="server" id="lblValor" class="p-1 font-weight-bold rounded bg-primary text-white">S/. 0</label>
                                </div>
                            </div>
                            <div class="table-responsive">
                                <asp:GridView ID="gdPedido" runat="server" CssClass="table table-sm table-hover table-bordered" AutoGenerateColumns="false" OnRowCommand="gdPedido_RowCommand"
                                    ShowHeaderWhenEmpty="true" EmptyDataText="Sin registro de pedidos">
                                ...
                                <ContentTemplate>
                                    <div class="table-responsive">
                                        <asp:GridView ID="gdCartaProductos" runat="server" AutoGenerateColumns="false" OnRowCommand="gdCartaProductos_RowCommand"
                                            CssClass="table table-sm table-hover table-bordered" OnDataBound="gdCartaProductos_DataBound" ShowHeaderWhenEmpty="true" EmptyDataText="Sin registro productos">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-row justify-content-end">
                                    <div class="col-md-3">
                                        <asp:LinkButton ID="btnguardar" CssClass="btn btn-success" runat="server" Style="border-radius: 15px;" OnClick="btnguardar_Click">
                                Guardar 
