<%@ Page Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" Inherits="frmMesas" CodeBehind="frmMesas.aspx.cs" %>
...
.mesa-btn:hover {
    ...
    <script>
        ...
        function VerPedidosLllevar() {
            document.getElementById("<%=btnPllevar.ClientID%>").click();
        }
        ...
        function ejecutarCadaDosSegundos() {

            document.getElementById("<%=sub.ClientID%>").click();
        }

        // setInterval llama a la función ejecutarCadaDosSegundos cada 2000 milisegundos (2 segundos)
        //setInterval(ejecutarCadaDosSegundos, 2000);
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <button id="sub" Style="display: none" runat="server" type="submit" ></button>
                ...
                <div class="container mb-4 pb-3 pt-3 shadow bg-body rounded">
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 d-flex justify-content-end">
                            <button type="button" onclick="this.disabled=true;VerPedidosLllevar();" class="btn btn-info" style="border-radius: 15px;">
                                <i class="fa fa-bar-chart" aria-hidden="true"></i>
                                Pedidos para llevar
                            </button>
                            <asp:Button ID="btnPllevar" class="btn btn-secondary btn-lg" runat="server" Text="Ver Pedidos División" OnClick="btnPllevar_Click" Style="display: none" />
                        </div>
                    </div>
                </div>
                </ContentTemplate>
                    ...
                    <ContentTemplate>
                        <div class="modal-content">
                            <div class="modal-header shadow bg-body">
                                <h4 class="modal-title" id="myLargeModalLabel1">Listado de Pedidos Para Llevar</h4>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="table-responsive shadow-lg bg-body rounded">
                                                <asp:GridView ID="gdListadoPedidos" CssClass="table table-hover table-sm table-bordered mb-0" runat="server" AutoGenerateColumns="false"
                                                    ShowHeaderWhenEmpty="true" EmptyDataText="No se encontraron pedidos para llevar" OnRowCommand="gdListadoPedidos_RowCommand" OnRowDataBound="gdListadoPedidos_RowDataBound"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText=""
                                                            ...
                                                            ItemStyle-CssClass="align-middle">
                                                            <ItemTemplate>
                                                                <asp:LinkButton data-dismiss="modal" runat="server" ID="ibtBuscar" OnClientClick="detalle();" ToolTip="Detalle"
        ...
        <input type="hidden" id="Hreload" name="Hreload"></input>
    </form>
</asp:Content>
