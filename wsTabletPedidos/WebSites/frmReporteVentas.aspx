<%@ Page Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" Inherits="frmReporteVentas" CodeBehind="frmReporteVentas.aspx.cs" %>
            ...
            <ContentTemplate>
                        ...
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker" runat="server" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker2" runat="server" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-1 d-flex justify-content-end">
                            <asp:Button Style="display:none;" runat="server" ID="btnBuscar" OnClick="btnBuscar_Click" Text="Generar" CssClass="btn btn-outline-primary mr-2" />
                            ...
                            <asp:Button Style="display:none;" runat="server" ID="btnRegresar" OnClick="btnRegresar_Click" Text="Repetir" CssClass="btn btn-danger" />
                            ...
                            <asp:LinkButton Style="display:none;" runat="server" ID="imgExcelDescarga1" OnClick="imgExcelDescarga1_Click1" ToolTip="Descargar en formato EXCEL" CssClass="btn btn-outline-success" ></asp:LinkButton>
                ...
                <div class="table-responsive shadow-lg bg-body rounded">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-sm table-hover table-bordered mb-0"
                        PagerStyle-CssClass="pager" OnRowDataBound="GridView1_RowDataBound" PageSize="6" AllowPaging="true" OnPreRender="GridView1_PreRender" ShowHeaderWhenEmpty="true" EmptyDataText="Sin registros"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Movimiento Caja" DataField="Movimiento_Caja" />
                            <asp:BoundField HeaderText="Turno" DataField="Turno" />
                            <asp:BoundField HeaderText="Tipo Documento" DataField="Tipo_Documento" />
                            <asp:BoundField HeaderText="Numero Documento" DataField="Numero_Documento" />
                            <asp:BoundField HeaderText="Fecha Documento" DataField="FechaDocumento" />
                            <asp:BoundField HeaderText="Ruc Cliente" DataField="Ruc_Cliente" />
                            <asp:BoundField HeaderText="Nombre Razon Social" DataField="Nombre_Razon_Social" />
                            <asp:BoundField HeaderText="Medio de Pago" DataField="MedioPago" />
                            <asp:BoundField HeaderText="Medio Pago Detalle" DataField="MedioPagoDetalle" />
                            <asp:BoundField HeaderText="Tipo Moneda" DataField="Tipo_Moneda" />
                            <asp:BoundField HeaderText="Total Documento" DataField="Total_Documento" />
                            <asp:BoundField HeaderText="Usuario Creacion" DataField="Usuario_Creacion" />
                        </Columns>
