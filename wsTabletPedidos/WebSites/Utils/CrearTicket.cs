...
namespace CrearTicketVenta
{
    ...
    public class CrearTicket
    {
        ...
        public void EncabezadoVenta()
        {
            ...
            linea.AppendLine("ARTICULO            | CANT |  P / U  | TOTAL  ");
        }
        ...
        public void AgregaArticulo(string articulo, int cant, decimal precio, decimal importe)
        {
            ...
            if (cant.ToString().Length <= 5 && precio.ToString().Length <= 7 && importe.ToString().Length <= 8)
            {
                ...
                if (articulo.Length > 20)
                {
                    ...
                    elemento += espacios + precio.ToString("n2");//Agregamos el precio a la variable elemento
                ...
                else //Si no es mayor solo agregarlo, sin dar saltos de lineas
                {
                    ...
                    elemento += espacios + precio.ToString("n2");
        ...
        public void CortaTicket()
        {
            ...
            linea.AppendLine("\x1B" + "d" + "\x2"); //Avanza 9 renglones, Tambien varian
        }
        //Para abrir el cajon
