<%@ Page Title="" Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="frmReporteCajaEgresos.aspx.cs" Inherits="WebSites.frmReporteCajaEgresos" %>
            ...
            <ContentTemplate>
                        ...
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker11" runat="server" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker12" runat="server" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="table-responsive shadow-lg bg-body rounded">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-sm table-hover table-bordered mb-0"
                        PagerStyle-CssClass="pager" PageSize="6" AllowPaging="true" ShowHeaderWhenEmpty="true" EmptyDataText="Sin registros"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Fecha" DataFormatString="{0:dd/MM/yyyy}" DataField="movFecGen" />
                            <asp:BoundField HeaderText="Turno" DataField="movTurnoId" />
                            <asp:BoundField HeaderText="Precio" DataField="Precio" />
                            <asp:TemplateField HeaderText="Tipo Egreso">
                                <ItemTemplate>
                                    <%# GetTipoDescripcion(Eval("tipo")) %>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Motivo">
                                <ItemTemplate>
                                    <%# GetMotivoDescripcion(Eval("motivo")) %>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:BoundField HeaderText="Comentario" DataField="Observacion" />
                        </Columns>
