<%@ Page Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="frmReportePorMesero.aspx.cs" Inherits="WebSites.frmReportePorMesero" %>
                        ...
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker9" runat="server" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker10" runat="server" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="table-responsive shadow-lg bg-body rounded">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-sm table-hover table-bordered mb-0"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="ProductoCodigo" DataField="ProductoCodigo" />
                            <asp:BoundField HeaderText="ProductoNombre" DataField="ProductoNombre" />
                            <asp:BoundField HeaderText="cantidad" DataField="cantidad" />
                            <asp:BoundField HeaderText="Precio Unitario" DataField="Precio Unitario" />
                            <asp:BoundField HeaderText="Precio total S/." DataField="Precio total S/." />
                        </Columns>
