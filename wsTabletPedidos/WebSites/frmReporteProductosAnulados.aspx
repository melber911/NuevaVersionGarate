<%@ Page Language="C#" MasterPageFile="~/Menu.Master" AutoEventWireup="true" CodeBehind="frmReporteProductosAnulados.aspx.cs" Inherits="WebSites.frmReporteProductosAnulados" %>
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <div class="container mb-4 pb-3 pt-3 shadow bg-body rounded">
                    <div class="row mb-5">
                        <div class="col-md-12">
                            <h2>Reporte de Productos Anulados</h2>
                        </div>
                    </div>
                        ...
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker5" runat="server" />
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4 mb-1">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <input class="form-control" type="date" id="datepicker6" runat="server" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="table-responsive shadow-lg bg-body rounded">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="table table-sm table-hover table-bordered mb-0"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="OrdenID" DataField="OrdenID" />
                            <asp:BoundField HeaderText="Fecha" DataField="Fecha" />
                            <asp:BoundField HeaderText="NombreProducto" DataField="NombreProducto" />
                            <asp:BoundField HeaderText="Cantidad_Original" DataField="Cantidad_Original" />
                            <asp:BoundField HeaderText="Cantidad_Modificada" DataField="Cantidad_Modificada" />
                            <asp:BoundField HeaderText="MotivoAnulacion" DataField="MotivoAnulacion" />
